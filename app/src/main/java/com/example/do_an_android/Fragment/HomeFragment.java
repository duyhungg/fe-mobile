package com.example.do_an_android.Fragment;
...
//banner
    ...
    private void setAdapterSlider() {
        ...
        viewPager.setAdapter(sliderAdapter); // gọi slider adapter làm slider cho viewpage
        circleIndicator.setViewPager(viewPager); // kết nối với circleIndicator cập nhật vị trí slider
